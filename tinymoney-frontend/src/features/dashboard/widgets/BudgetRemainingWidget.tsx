...
type Props = { topRemaining: CategoryBudgetSummary[]; monthStart: Date; monthEnd: Date };

export function BudgetRemainingWidget({topRemaining, monthStart, monthEnd}: Props) {
    return (
        <Card>
            <CardHeader>
